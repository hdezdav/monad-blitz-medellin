...
export const cardsCatalog = [
  ...
  },
  {
    id: "monad-speed",
    tokenId: 7,
    name: "Paralelismo Monad",
    type: "Legendary",
    rarity: "legendary",
    description: "Ejecución ultra rápida de transacciones en paralelo. Te permite jugar 2 cartas ofensivas en el mismo turno.",
    image: "/images/cards/monad-speed.png",
    tone: "mint",
...
export const heroCards = cardsCatalog.map(card => ({
  ...card,
...
export const getCardById = (id) => cardsCatalog.find(card => card.id === id);
